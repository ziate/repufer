...
class CategoryLogic
{
    ...
    public static function products(int $category_id, int $restaurant_id, int $brand_id, int $zone_id, int $limit,int $offset, $type)
    {
    ...
    public static function cat_products(int $category_id, int $restaurant_id, int $brand_id, int $limit,int $offset, $type)
    {
        ...
        $data=[];
        foreach($paginator->items() as $da){
            $da['image'] = json_decode($da['image'])[0];
            array_push($data , $da);
        }
