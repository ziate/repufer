...
class FoodController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach($Attribute as $attr){
            if($request->has($attr['name'])){
                $Data_Attr_arr +=  [$attr['name']=>$request[$attr['name']]];
            }
        }

        $sub_Attributes = json_encode($Data_Attr_arr);
        ...
        $food->choice_options = $sub_Attributes;
        $variations = [];
        $options = [];
    ...
    public function edit($id)
    {
        ...
        return view('admin-views.product.edit', compact('product', 'product_category', 'categories','brands'));
    }
...
//                    'updated_at'                => now()
    ...
    public function Check_Attr_Id(Request $request){


        $data = \App\Models\Attribute::where('id',$request['id'])->first()->sub_attributes;
