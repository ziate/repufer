...
return [
    ...
    'alert_restaurant_out_from_campaign'=> 'You want your shop out from this campaign?',
    ...
    'collect'=>'Collect',
    'collected_cash_by_restaurant'=>'Collected cash by shop',
    'collect_cash_from_restaurant'=>'Collect cash from shop',
    ...
    'food_wise_report'=>'product Wise Report',
    'deleted'=>'deleted',
    'delivered' => 'Delivered',
    ...
    'product_imported_successfully'=>':count - products imported successfully!',
    ...
    'location'=>'Location',
    'login' => 'login',
    'restaurant_application'=>'shop Application',
    'restaurant_required_warning'=>'Make sure you have selected a shop first!',
    'restaurant_temporarily_closed'=>'shop temporarily closed sucessfully',
    'restaurant_temporarily_closed_title'=>'shop temporarily closed',
    'restaurant_opened'=>'shop opened successfully',
    'restaurant_settings_updated'=>'shop settings updated!',
    'restaurant_registration'=>'shop Registration',
    ...
    'select_zone_for_map'=>' Select a zone based on your shop location. After selecting the zone you can see the zone on the map',
    'show_hide_food_menu'=>'By disable it, shop will not be able to manage (edit, update, delete or change status) any product but can view all products.',
    'show_hide_reviews_menu'=>'Show or hide reviews menu from shop panel.',
    'show_locations_on_map'=>'Show locations on map',
    'system'=>'System',
    'restaurant_lat_lng_warning'=>'Select your shop’s exact location from the map (Just click on the map for pick location). The location must be inside the selected zone.',
    ...
    'restaurant_data_updated'=>'shop data updated successfully!',
    'restaurant_settings_updated'=>'shop settings updated!',
    'restaurant_not_found'=>'shop not found!',
    ...
    'please_select_restaurant'=>'Please select a shop!',
    'read_more'=>'Read More...',
    'select_category'=>'Select Category',
    'select_date'=>'select date!',
    'select_restaurant'=>'select shop',
    'select_zone'=>'select zone',
    'select_food'=>'Select product',
    ...
    'required'=>'required',
    'restaurant'=>'shop',
    'restaurant_commission'=>'shop commission',
    'restaurant_view'=>'shop view',
    'restaurant_is_closed_at_order_time'=>'shop is closed at orderd time',
    'restaurant_owner_login_form'=>'shop Owner Login Form',
    'returned' => 'Returned',
    'reviews'=>'Reviews',
    ...
    'scheduled_date_is_restaurant_offday'=>'Sorry! Order scheduled date is shop offday. Please chose another date',
    'secret' => 'secret',
    ...
    'signin'=>'Signin',
    'sign_in_as_employee'=>'Sign in as shop Employee',
    'sign_in_as_owner'=>'Sign in as shop Owner',
    ...
    'preparingInRestaurants'=>'product Preparing in Shops',
    'foodOnTheWay'=> 'product on the Way',
    ...
    'employee_welcome_message'=>'Hello, here you can manage your shops.',
    ...
    'food'=>'product',
    'foods'=>'products',
    'food_item'=>'product item',
    'item_name_required'=>'product name is required!',
    'item_type_is_required'=>'Item type is required',
    'food_section'=>'Manage product',
    'food_status_updated'=>'product status updated!',
    'food_not_found'=>'product not found',
    'charge'=>'Charge',
    'campaign'=>'Campaign',
    'campaigns'=>'Campaigns',
    ...
    'restaurants'=>'shops',
    'restaurant_added_to_campaign'=>'shops added to Campaign!',
    'restaurant_imported_successfully'=>':count - shops imported successfully!',
    'restaurant_remove_from_campaign'=>'shops removed from Campaign!',
    'restaurant_wise'=>'shops wise',
    'vendor_view'=>'shop View',
    'bank_info'=>'Bank Info',
    'bank_name'=>'Bank Name',
    ...
    'not_fund'=>'Not found!',
    'Used_Market_Settings' =>'Used Market Settings',
    ...
    'you_can_not_edit_this_restaurant_please_add_a_new_restaurant_to_edit'=>'Sorry!You can not edit this shop. Please add a new shop to edit',
    'you_can_not_delete_this_restaurant_please_add_a_new_restaurant_to_delete'=>'Sorry!You can not delete this shop. Please add a new shop to delete',
    ...
    'you_want_to_temporarily_close_this_restaurant'=>'You want to temporarily close this shop?',
    'you_want_to_open_this_restaurant'=>'You want to change the active status to open for this shop?',
    ...
    'order_updated_successfully'=>'Order updated successfully',
    'top_selling_foods'=>'Top selling products',
    'top_content_image'=>'Top Content Image',
    'popular_restaurants'=>'Popular shops',
    'most_reviewed_foods'=>'Most Reviewed products',
    'new_business'=>'New Business',
    'new_campaign'=>'New Campaign',
    'new_category'=>'New Category',
    'new_coupon'=>'New coupon',
    'new_food'=>'New product',
    'new_restaurants'=>'New shops',
    ...
    'new_zone'=>'New Zone',
    'popular_foods'=>'Popular products',
    'total_sell'=>'Total Sell',
    'total_order_amount'=>'Total order amount',
    'total_uses'=>'Uses Count',
    'top_rated_foods'=>'Most rated products',
    'top_deliveryman'=>'Top delivery man by order count',
    'top_customers'=>'Top customers',
    'top_restaurants'=>'Top shops by order delivered',
    'commission_earned'=>'Commission Earned',
    'admin_commission'=>'Admin commission',
    'refund_requested'=>'Refund Requested',
    'can_not_add_both_food_and_restaurant_at_same_time'=>'Can not add both product and shop at same time!',
    ...
    'food_on_the_way'=>'product on the way',
    'yearly_statistics'=>'Yearly Statistics',
    'commission_given'=>'Commission Given',
    'followup'=>"Followup your shop's activities",
    ...
    'you_want_to_change_this_restaurant_status'=>'You want to change status for this shop status?',
    ...
    'trusted_by_restaurant'=>'shop Owner',
    ...
    'thirsday'=>'Thursday',
    'friday'=>'Friday',
    'restaurant_cancellation_toggle'=>'shop can cancel a order',
    ...
    'restaurant_employee_login_form'=>'shop Employee Login Form',
    'add_new_restaurant'=>'Add new shop',
    ...
    'product_unavailable_warning'=>'One or more products in your cart is not available. Please clear your cart and try again.',
    ...
    'restaurant_self_registration'=>'shop self registration',
    ...
    "Restaurant is required when banner type is restaurant wise"=>"shop is required when banner type is shop wise",
    "Food is required when banner type is food wise"=>"product is required when banner type is product wise",
    ...
    'Food Bulk Import'=>'product Bulk Import',
    'Import Food`s File'=>'Import product`s File',
    ...
    'Restaurant deleted!'=>'shop deleted!',
    'Food deleted!'=>'product deleted!',
    'reset'=>'Reset',
    'Unauthorized'=>'Unauthorized.',
    'Export Restaurants'=>'Export shops',
    'star'=>'star',
    ...
    'End time'=>'End time',
    'Restaurant settings updated!'=>'shop settings updated!',
    ...
    'Fixed_Productss'=>'fixed products',
    'add_fixed_products'=>'add fixed products',
    'new_Fixed_Products'=>'add fixed products',
    '_select_product' =>'select product',
    'product_review' =>'product review',
    'seection_review' =>'product review',
    'sub_category' => 'sub Category',
    ...
    'search_sub_Sub_Categories'=>'search sub Sub Categories',
    'sub_sub_sub_category' => 'sub sub sub category',
    'brand' => 'brand ',
    'brandName' => 'brand Name',
    'brandName_ar' => 'brand Name AR',
    'brandName_en' => 'brand Name EN',
