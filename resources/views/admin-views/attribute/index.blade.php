            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.attribute.store')}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group" id="inputs_attributes">
                                <lable class="input-label" for="attributes">{{__('messages.new_attribute')}} ( {{__('messages.sub')}} )</lable>
                                <select name="attributesInputs[]" id="attributes"
