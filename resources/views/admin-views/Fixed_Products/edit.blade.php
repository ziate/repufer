        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i> {{__('messages.Fixed_Products')}} {{__('messages.update')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
...
@push('script_2')
    <script>
        ...
        $(document).ready(function () {
            setTimeout(function () {
                ...
                getRequest('{{url('/')}}/admin/Fixed_Products/get-categories?parent_id=' + category + '&sub_category=' + sub_category, 'sub-categories');
    ...
    <script>
        $('#product_form').on('submit', function () {
            ...
            $.post({
                url: '{{route('admin.Fixed_Products.update',[$product['id']])}}',
                data: $('#product_form').serialize(),
                data: formData,
                cache: false,
                contentType: false,
