    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i> {{__('messages.Add')}} {{__('messages.product')}} </h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.Used_Market.store')}}" method="post" id="product_form"
                        ...
                        @foreach(json_decode($language) as $lang)
                            ...
                            <div class="card p-4 {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[]" id="{{$lang}}_name" class="form-control" placeholder="{{__('messages.new_Fixed_Products')}}" value="" {{$lang == $default_lang? 'required':''}} oninvalid="document.getElementById('en-link').click()">
                                </div>
                    ...
                    @else
                        <div class="card p-4" id="{{$default_lang}}-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="name[]" class="form-control" placeholder="{{__('messages.new_Fixed_Products')}}" value="" required>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="" min="0" max="100000" name="price"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="tel" value="" required name="phone" class="form-control" id="phone"
