...
@section('title','Brands Bulk Import')
...
@section('content')
    <div class="content container-fluid">
        ...
        <h1 class="text-capitalize">{{__('messages.brand')}} {{__('messages.bulk_import')}}</h1>
        <!-- Content Row -->
        <div class="row">
            <div class="col-12">
            ...
            <div class="col-md-12">
                <form class="product-form" action="{{route('admin.brands.bulk-import')}}" method="POST"
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        <input type="file" name="brands_file">
                                    </div>
                                </div>
                            </div>
                        </div>
