...
<head>
    ...
    <!-- CSS Front Template -->
    <link rel="stylesheet" href="{{asset('public/assets/admin')}}/css/theme.minc619-{{ App::getLocale()=='ar'?'rtl':'ltr' }}.css?v=1.0">
...
<main id="content" role="main" class="main pointer-event" dir="{{ App::getLocale()=='ar'?'rtl':'ltr' }}">
    <!-- Content -->
@yield('content')
<!-- End Content -->
