            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="javascript:" method="post" id="product_form"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-6">
                            <input name="veg" type="hidden" value="0"/>
                            <!--<div class="form-group">-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-12">
                            <div class="form-group">
                                ...
                                <select name="sub_category_id" id="sub-categories" onchange="getRequest('{{url('/')}}/vendor-panel/food/get-sub_categories?parent_id='+this.value,'sub_sub_category_id')"
                        ...
                        <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlSelect1">{{__('messages.sub_sub_category')}}<span
                                                class="input-label-secondary" title="{{__('messages.category_required_warning')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.category_required_warning')}}"></span></label>
                                        <select name="sub_sub_category_id" id="sub_sub_category_id" onchange="getRequest('{{url('/')}}/vendor-panel/food/get-sub_categories?parent_id='+this.value,'sub_sub_sub_category_id')"
                                                class="form-control js-select2-custom">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlSelect1">{{__('messages.brand')}}<span
                                        class="input-label-secondary"></span></label>
                                <select name="brand_id" class="form-control js-select2-custom" readonly>
