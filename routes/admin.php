...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        // Start Sizes & NL
        Route::get('Sizes','SizesController@SizesFront')->name('SizesFront');
        Route::post('add-Sizes','SizesController@store')->name('size.store');
        Route::get('delete-Sizes/{id}','SizesController@delete')->name('size.delete');
        Route::post('update-Sizes/{id}','SizesController@update')->name('size.update');
        
        Route::get('Nl','NlController@NlFront')->name('NlFront');
        Route::post('add-Nl','NlController@store')->name('nl.store');
        Route::get('delete-Nl/{id}','NlController@delete')->name('nl.delete');
        Route::post('update-Nl/{id}','NlController@update')->name('nl.update');
        ...
        Route::group(['prefix' => 'food', 'as' => 'food.', 'middleware' => ['module:food']], function () {
            ...
            Route::post('Check_Attr_Id', 'FoodController@Check_Attr_Id')->name('Check_Attr_Id');
            ...
            Route::get('get-sub_categories', 'FoodController@get_sub_categories')->name('get-sub_categories');
        ...
        Route::group(['prefix' => 'brands', 'as' => 'brands.', 'middleware' => ['module:Brands']], function () {
            Route::get('add-new', 'BrandsController@index')->name('add-new');
            Route::post('store', 'BrandsController@store')->name('store');
            Route::get('edit/{brands}', 'BrandsController@edit')->name('edit');
            Route::post('update/{brands}', 'BrandsController@update')->name('update');
            Route::delete('delete/{brands}', 'BrandsController@delete')->name('delete');
            Route::post('search', 'BrandsController@search')->name('search');

            //Import and export
            Route::get('bulk-import', 'BrandsController@bulk_import_index')->name('bulk-import');
            Route::post('bulk-import', 'BrandsController@bulk_import_data');
            Route::get('bulk-export', 'BrandsController@bulk_export_index')->name('bulk-export-index');
            Route::post('bulk-export', 'BrandsController@bulk_export_data')->name('bulk-export');
        });
        ...
        Route::group(['prefix' => 'Used_Market', 'as' => 'Used_Market.'], function () {
            Route::get('customers', 'Used_MarketController@customers')->name('customers');
            Route::get('products', 'Used_MarketController@products')->name('products');
            Route::get('add', 'Used_MarketController@add')->name('add');
            Route::post('store', 'Used_MarketController@store')->name('store');
            Route::get('edit/{id}', 'Used_MarketController@edit')->name('edit');
            Route::post('update/{id}', 'Used_MarketController@update')->name('update');
            Route::delete('delete/{id}', 'Used_MarketController@delete')->name('delete');
            Route::get('Used_Market_Settings', 'Used_MarketController@Used_Market_Settings')->name('Used_Market_Settings');
            Route::post('update', 'Used_MarketController@UpdateSettings')->name('UpdateSettings');
        });
            ...
            Route::group(['prefix' => 'Fixed_Products', 'as' => 'Fixed_Products.', 'middleware' => ['module:Fixed_Products']], function () {
                ...
                Route::get('list', 'Fixed_ProductsController@list')->name('list');
                Route::delete('delete/{id}', 'Fixed_ProductsController@delete')->name('delete');
                Route::get('status/{id}/{status}', 'Fixed_ProductsController@status')->name('status');
                Route::get('review-status/{id}/{status}', 'Fixed_ProductsController@reviews_status')->name('reviews.status');
                Route::post('search', 'Fixed_ProductsController@search')->name('search');
                Route::get('reviews', 'Fixed_ProductsController@review_list')->name('reviews');

                Route::get('view/{id}', 'Fixed_ProductsController@view')->name('view');
                //ajax request
                Route::get('get-categories', 'Fixed_ProductsController@get_categories')->name('get-categories');
                Route::get('get-Fixed_Productss', 'Fixed_ProductsController@get_Fixed_Productss')->name('getFixed_Productss');

                //Import and export
                Route::get('bulk-import', 'Fixed_ProductsController@bulk_import_index')->name('bulk-import');
                Route::post('bulk-import', 'Fixed_ProductsController@bulk_import_data');
                Route::get('bulk-export', 'Fixed_ProductsController@bulk_export_index')->name('bulk-export-index');
                Route::post('bulk-export', 'Fixed_ProductsController@bulk_export_data')->name('bulk-export');
            });
        ...
        Route::group(['prefix' => 'events', 'as' => 'events.'], function () {
            ...
            Route::get('attendance/{id}', 'EventController@attendance')->name('attendance');
        });

        Route::group(['prefix' => 'product_review', 'as' => 'product_review.'], function () {
            Route::get('add-new', 'Fixed_ProductsController@index')->name('add-new');
                Route::post('variant-combination', 'Fixed_ProductsController@variant_combination')->name('variant-combination');
                Route::post('store', 'Fixed_ProductsController@store')->name('store');
                Route::get('edit/{id}', 'Fixed_ProductsController@edit')->name('edit');
        ...
        Route::group(['prefix' => 'Sub_Categories', 'as' => 'Sub_Categories.'], function () {
                Route::get('get-all', 'Sub_CategoryController@get_all')->name('get-all');
                Route::group(['middleware' => ['module:Sub_Categories']], function () {
                    Route::get('add', 'Sub_CategoryController@index')->name('add');
                    Route::get('add-sub-category', 'Sub_CategoryController@sub_index')->name('add-sub-category');
                    Route::get('add-sub-sub-category', 'Sub_CategoryController@sub_sub_index')->name('add-sub-sub-category');
                    Route::post('store', 'Sub_CategoryController@store')->name('store');
                    Route::get('edit/{id}', 'Sub_CategoryController@edit')->name('edit');
                    Route::post('update/{id}', 'Sub_CategoryController@update')->name('update');
                    Route::get('update-priority/{category}', 'Sub_CategoryController@update_priority')->name('priority');
                    Route::post('store', 'Sub_CategoryController@store')->name('store');
                    Route::get('status/{id}/{status}', 'Sub_CategoryController@status')->name('status');
                    Route::delete('delete/{id}', 'Sub_CategoryController@delete')->name('delete');
                    Route::post('search', 'Sub_CategoryController@search')->name('search');

                    //Import and export
                    Route::get('bulk-import', 'Sub_CategoryController@bulk_import_index')->name('bulk-import');
                    Route::post('bulk-import', 'Sub_CategoryController@bulk_import_data');
                    Route::get('bulk-export', 'Sub_CategoryController@bulk_export_index')->name('bulk-export-index');
                    Route::post('bulk-export', 'Sub_CategoryController@bulk_export_data')->name('bulk-export');
                });
        });
