...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    // Brands
    Route::get('brands/{shop_id}/{cat_id}', 'CategoryController@getBrands');
    
    Route::get('prodducts-of-brand/{category_id}', 'CategoryController@getProductsOfBrand');

    // Events
       Route::get('events', 'EventController@index');
    Route::group(['middleware' => 'auth:api'], function () {
     
        Route::get('events/attend/{id}', 'EventController@attend');
    });


    Route::group(['prefix' => 'categories'], function () {
        Route::get('/{shop_id}', 'CategoryController@get_categories');
    ...
    Route::group(['prefix' => 'cart', 'middleware' => 'auth:api'], function () {
        Route::get('list/{id}', 'CartController@index');
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'wish-list'], function () {
            ...
            Route::delete('remove', 'WishlistController@remove_from_wishlist');
                 ...
                 // Used Market
        Route::group(['prefix'=>'used-market'], function(){
            Route::get('/', 'UsedMarketController@index');
            Route::post('store', 'UsedMarketController@store');
            Route::post('update/{id}', 'UsedMarketController@update');
            Route::delete('delete/{id}', 'UsedMarketController@delete');
